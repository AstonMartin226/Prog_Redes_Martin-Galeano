...
import Guia1Ejercicios.Ejercicios;
    ...
    public static void main(String[] args) {
        ...
        while (opcion != 0) {
            ...
            try {
                ...
                switch (opcion) {
                    case 1 -> Ejercicios.ejercicio1(ps);
                    case 2 -> Ejercicios.ejercicio2(ps);
                    case 3 -> Ejercicios.ejercicio3(ps);
                    case 4 -> Ejercicios.ejercicio4(ps);
                    case 5 -> Ejercicios.ejercicio5(ps);
                    case 6 -> Ejercicios.ejercicio6(ps);
                    case 7 -> Ejercicios.ejercicio7(ps);
                    case 8 -> Ejercicios.ejercicio8(ps, psErr, br);
                    case 9 -> Ejercicios.ejercicio9(ps, psErr, br);
                    case 10 -> Ejercicios.ejercicio10(ps, psErr, br);
                    case 11 -> Ejercicios.ejercicio11(ps, psErr, br);
                    case 12 -> Ejercicios.ejercicio12(ps, psErr, br);
                    case 13 -> Ejercicios.ejercicio13(ps, psErr, br);
                    case 14 -> Ejercicios.ejercicio14(ps, psErr, br);
                    case 15 -> Ejercicios.ejercicio15(ps, psErr, br);
                    case 0 -> ps.println("Saliendo del programa...");
                    default -> psErr.println("Opción inválida. Intente nuevamente.");
                }
