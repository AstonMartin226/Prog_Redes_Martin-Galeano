...
public class LeerCarpeta implements Runnable{
	...
	public int LeerArchivos() {
		...
		try {
			...
			Logger.getLogger(LeerCarpeta.class.getName()).log(Level.WARNING, null, e);
		}
		catch(IOException e) {
			Logger.getLogger(LeerCarpeta.class.getName()).log(Level.WARNING, null, e);
		}finally {
