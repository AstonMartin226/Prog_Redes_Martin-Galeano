...
public class Control implements Runnable {
    ...
    public void run() {
        ...
        while (true) {
            synchronized (Registro.listaEmpleados) {
                while (revisados < Registro.listaEmpleados.size()) {
                    Empleados e = Registro.listaEmpleados.get(revisados);
                    String estado;
                ...
                if (Thread.activeCount() == 2 && revisados == Registro.listaEmpleados.size()) {
